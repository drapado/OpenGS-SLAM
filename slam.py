    ...
    def __init__(self, config, d3r_model, save_dir=None):
        ...
        if self.eval_rendering:
            ...
            eval_rendering(
                ...
                validation_start_frame=0,
                validation_end_frame=validation_start_frame,
            )

            # Rendering on validation frames
            ...
            if self.color_refinement:  # Currently disabled
...
if __name__ == "__main__":
    ...
    if config["Results"]["save_results"]:
        ...
        save_dir = os.path.join(config["Results"]["save_dir"], path[-3] + "_" + path[-2], current_datetime)
        tmp = args.config
        tmp = tmp.split(".")[0]
