...
def main():
    ...
    agri_stage = "flowering"
    agri_scene = f"{agri_orchard}{agri_stage}"
    
    # Process each camera
    for camera_name in camera_names:
        gt_file = f'/workspaces/OpenGS-SLAM/datasets/agri/3d-pear_flowering_train_val_f5/groundtruth_cam_2.csv'
        pred_file = f'/workspaces/OpenGS-SLAM/results/datasets_agri/3d-pear_flowering_train_val_f5/trajectory_gps.txt'
